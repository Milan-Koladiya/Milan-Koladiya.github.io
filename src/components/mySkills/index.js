...
const skillsData = [
    { icon: disk, title: "80 Albumes Listened" },
    { icon: trophy, title: "15 Awards Won" },
    { icon: mug, title: "1 000 Cups of coffee" },
    { icon: flag, title: "10 Countries Visited" }
];
    ...
    return (
        <div id="skills" className="relative py-[60px] md:py-[100px]">
            <div className="container mx-auto px-15">
                <SectionTitle title="MY SKILLS" desc="A Lead UX & UI designer based in Canada" />
